...
const App = () => {
  const jobOpenings = [
    ...
    {
      brandLogo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTV-dvz7AfvZEZ55pZnq9ABa5zXfLZyVOVWJ7VDlgETrg&s=10",
      companyName: "Google",
    ...
    {
      brandLogo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSkBwIg8FnTVdq-lA1bnuZm4nQETFJsrp_OYpKrWhthjGhGdX1CCPqi_vx&s=10",
      companyName: "IBM",
