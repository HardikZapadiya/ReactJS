  ...
  const users = [
    {
      ...
      intro:
        "Discover the latest job opportunities from top companies and find the role that matches your skills and career goals",
      color: "Green",
      tag: "Satisfied",
    },
    {
      ...
      color: "orange",
      intro:
        "Join our team to build high-quality digital products, solve real-world problems, and grow your career with experienced professionals.",
      tag: "Underserved",
    },
    {
      ...
      color: "gray",
      intro:
        "Banking tools designed to help underbanked communities manage money with confidence.",
      tag: "Underbanked",
    },
    {
      ...
      color: "teal",
      intro:
        "Open an account, track spending, and manage everyday payments in one place.",
      tag: "Underwear",
    },
    {
      ...
      intro:
        "Send money securely, pay bills instantly, and stay in control of your finances.",
      color: "maroon",
      tag: "Average",
    },
  ];
